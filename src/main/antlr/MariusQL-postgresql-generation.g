 ...
 **********************************************************************************/
package fr.ensma.lias.mariusql.driver.postgresql.antlr;
 ...
 */
class PostgesSQLGeneratorBase extends TreeParser;
...
options {
	...
	exportVocab=PostgresSQL;    // Call the resulting definitions "PostgresSql"
...
{
	private static Logger log = LoggerFactory.getLogger(PostgesSQLGeneratorBase.class);
