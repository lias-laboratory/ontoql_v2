...
/**
 * Represents an aggregate (count, min, max ...) function.
 *
 * @author Valentin CASSAIR
 */
public class AggregateNode extends AbstractSelectExpression {

	private static final long serialVersionUID = -4276201673303701477L;
