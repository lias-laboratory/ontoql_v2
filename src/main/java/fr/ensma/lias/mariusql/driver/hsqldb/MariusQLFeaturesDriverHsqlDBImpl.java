 ...
 */
public class MariusQLFeaturesDriverHsqlDBImpl extends AbstractMariusQLDriver implements MariusQLFeaturesDriver {

	public MariusQLFeaturesDriverHsqlDBImpl(MariusQLSession pSession) {
		super(pSession);
	}
