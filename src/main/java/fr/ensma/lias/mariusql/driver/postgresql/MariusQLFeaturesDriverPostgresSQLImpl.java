 ...
 */
public class MariusQLFeaturesDriverPostgresSQLImpl extends AbstractMariusQLDriver implements MariusQLFeaturesDriver {

	public MariusQLFeaturesDriverPostgresSQLImpl(MariusQLSession pSession) {
		super(pSession);
	}
